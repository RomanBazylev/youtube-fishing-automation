"""Upload generated fishing short to YouTube via Data API v3.
...
VIDEO_PATH = BUILD_DIR / "output_fishing_short.mp4"
...
def _load_metadata() -> dict:
    ...
    if METADATA_PATH.is_file():
        ...
        return {
            "title": data.get("title", "Рыбалка #shorts")[:100],
            "description": data.get("description", "#рыбалка #fishing #shorts"),
            "tags": data.get("tags", ["рыбалка", "fishing", "shorts"]),
        }
    return {
        "title": "Рыбалка: секреты и лайфхаки #shorts",
        "description": "Смотри до конца! #рыбалка #fishing #shorts",
        "tags": ["рыбалка", "fishing", "shorts"],
    }
...
if __name__ == "__main__":
    ...
    if not vid:
        ...
        sys.exit(0)  # Don't fail the workflow if upload is optional
